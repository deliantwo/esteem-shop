...
plague = Game.create(name: "Plague Inc", description: "Some descritpion", category: Category.find_by(name: "RTS"), publisher: Publisher.find_by(name: "Ndemic Creations"), producer: Producer.find_by(name: "Sun Games Interactive"))
