...
Gamekey.create(content: "XXXXXXXXXXX1", price_platform_game: PricePlatformGame.find_by(game: "Plague Inc", platform: "Steam"))
Gamekey.create(content: "XXXXXXXXXXX2", price_platform_game: PricePlatformGame.find_by(game: "Plague Inc", platform: "Steam"))
Gamekey.create(content: "XXXXXXXXXXX3", price_platform_game: PricePlatformGame.find_by(game: "Plague Inc", platform: "Origin"))
Vat.create(value: 23)