...
Game.create(name: "Totally not a GTAV", description: "Some descritpion2", category: Category.find_by(name: "RPG"), publisher: Publisher.find_by(name: "Ndemic Creations"), producer: Producer.find_by(name: "Ndemic Creations"))